    ...
    <div className="max-w-7xl mx-auto">
      <header className="flex justify-between p-5 max-w-7xl mx-auto">
        <div className="flex items-center space-x-5">
          <Link href="/">
            <svg height={25} viewBox="0 0 3940 610" className="object-contain cursor-pointer fill-black">
...
// notes on Image options
/* <Image className='w-44 object-contain cursor-pointer' src={logo} alt="Medium Logo" /> */
